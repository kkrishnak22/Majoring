...
class _UploadCourseScreenState extends State<UploadCourseScreen> {
  ...
  TextEditingController courseVideoLinkController=TextEditingController();
      ...
      appBar: AppBar(
       ...
       body:Column(
         children: [
           ...
           TextFieldInput(
             hintText: 'course video Link',
             textInputType: TextInputType.text,
             textEditingController:courseVideoLinkController ,
           ),
           TextFieldInput(
           ...
           CustomMainButton(
               ...
               onPressed: () async {
                 ...
                 String output = await CloudFirestoreClass()
                   ...
                   courseuid: uid.toString(),
                   courseVideoLink: courseVideoLinkController.text,
